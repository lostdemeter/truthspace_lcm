...
```python
from truthspace_lcm.gears.core import GearProtocol, GearMessage
...
```python
from truthspace_lcm.gears.core import adapt_to_gear_state, adapt_from_gear_state
...
```python
from truthspace_lcm.gears.core import EmergentIntentSpace
