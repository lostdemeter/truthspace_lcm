...
"""
    ...
    from truthspace_lcm.practical_applications.chat.api_server import DEFAULT_LLM_URL, DEFAULT_LLM_MODEL
    ...
    from truthspace_lcm.practical_applications.chat.api_server import EmergentChatEngine, Message as APIMessage
    ...
    async def chat(request: Request):
        ...
        if "tools" in raw_body:
            from truthspace_lcm.practical_applications.chat.api_server import Tool
