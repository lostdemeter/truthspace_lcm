#!/usr/bin/env python3
"""
Phase 10p: Geometric Simple Machines — Error Decomposition
Decompose 0.85° error between measured (68.39°) and arccos(1/φ²) (67.54°).
Measure per-layer: damper, lever, wedge, spring. Build ideal machines. Doc 261.
"""
...
print("="*80)
print("  PHASE 10p: GEOMETRIC SIMPLE MACHINES")
print("="*80)
...
# Load helper: build bias-aware tables
...
# Load analysis helper
exec(open(os.path.join(os.path.dirname(__file__), 'phase10p_analysis.py')).read())
